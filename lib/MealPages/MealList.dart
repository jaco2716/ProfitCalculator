                    ...
                    child: FutureBuilder(
                        ...
                        builder: (context, vatSnapshot) {
                          ...
                          return FutureBuilder(
                              future: _sharedValueHandler.getIntSharedP(
                                  'hourPrice', 100),
...
//List Tile for every meal
  Widget mealListTile(Meal meal) {
    //double profitWMinutes = meal.profit - (_hourPrice/60*meal.minutesToMake);
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Row(
          ...
          children: [
            Text(
              '${(meal.salePrice / (_vatPercent / 100 + 1)).toStringAsFixed(2)},-',
